    ...
    <div className="fixed ~w-14/20 h-auto flex flex-col items-center z-60">
      ...
      <div>
        <button
          ...
          className={`z-60 fixed bottom-20 ~left-4/14 bg-black/20 hover:bg-[#0A5EB0] ~w-12/14 ~h-12/14 rounded-full text-yellow-100 text-[10px] md:text-xs flex items-center justify-center hover:scale-110 transition-all duration-300 ${
